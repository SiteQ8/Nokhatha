...
const P = {
  ...
  boat: '<path d="M3.5 15.5h17l-2.8 4H6.3Z"/><path d="M11.5 3v12.5M11.5 4.5 18 13h-6.5"/>',
  bike: '<circle cx="5.5" cy="16" r="3.2"/><circle cx="18.5" cy="16" r="3.2"/><path d="M5.5 16h5.5l2.5-5.5h3.5l1.5 5.5M13.5 10.5 12 7.5H9.5M15.5 7.5h2.5"/>',
  waves: '<path d="M3 9c1.5-1.3 3-1.3 4.5 0s3 1.3 4.5 0 3-1.3 4.5 0 3 1.3 4.5 0M3 14c1.5-1.3 3-1.3 4.5 0s3 1.3 4.5 0 3-1.3 4.5 0 3 1.3 4.5 0M3 19c1.5-1.3 3-1.3 4.5 0s3 1.3 4.5 0 3-1.3 4.5 0 3 1.3 4.5 0"/>',
  leaf: '<path d="M5 19C5 10.5 10.5 5 19 5c0 8.5-5.5 14-14 14Z"/><path d="M5 19 13.5 10.5"/>',
  tent: '<path d="M2.5 20h19M4.5 20 12 5l7.5 15M12 5v15M9.5 20 12 14.5l2.5 5.5"/>',
...
// The mark: the letter noon that opens the name, the hull of a boom and the Gulf crescent
// lying on its back like a boat, a lateen sail, and the pearl, or Suhail, as its dot.
// Generated by tools/make-brand.py.
export const MARK_BODY =
  '<g transform="translate(-3.31 0.36) scale(0.27478) rotate(-7 128 128)"><path class="mk-sail" d="M76 18 214 120Q160 146 96 138Q82 80 76 18Z"/><path class="mk-hull" d="M18 132A114.78 114.78 0 0 0 238 132A186.06 186.06 0 0 1 18 132Z"/><circle class="mk-pearl" cx="206" cy="46" r="21"/></g>';
